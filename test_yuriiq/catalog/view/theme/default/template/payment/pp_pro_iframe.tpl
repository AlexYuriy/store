<?php if ($checkout_method == 'iframe') { ?>
  <iframe name="hss_iframe" width="560px" height="540px" style="border:0 solid #DDDDDD; margin-left:210px;" scrolling="no" src="<?php echo HTTPS_SERVER.'index.php?route=payment/pp_pro_iframe/create'; ?>"></iframe>
<?php } else { ?>
