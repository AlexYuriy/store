          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              <tr>
                ...
                <td><input type="text" name="news_description[<?php echo $language['language_id']; ?>][name]" maxlength="255" size="100" value="<?php echo isset($news_description[$language['language_id']]) ? $news_description[$language['language_id']]['name'] : ''; ?>" />
              ...
              <tr>
                ...
                <td><input type="text" name="news_description[<?php echo $language['language_id']; ?>][seo_h1]" maxlength="255" size="100" value="<?php echo isset($news_description[$language['language_id']]) ? $news_description[$language['language_id']]['seo_h1'] : ''; ?>" /></td>
              </tr>
              <tr>
                <td><?php echo $entry_seo_title; ?></td>
                <td><input type="text" name="news_description[<?php echo $language['language_id']; ?>][seo_title]" maxlength="255" size="100" value="<?php echo isset($news_description[$language['language_id']]) ? $news_description[$language['language_id']]['seo_title'] : ''; ?>" /></td>
              </tr>
              <tr>
                <td><?php echo $entry_meta_keyword; ?></td>
                <td><input type="text" name="news_description[<?php echo $language['language_id']; ?>][meta_keyword]" maxlength="255" size="100" value="<?php echo isset($news_description[$language['language_id']]) ? $news_description[$language['language_id']]['meta_keyword'] : ''; ?>" /></td>
              </tr>
              <tr>
          ...
          <table class="form">
            <tr>
              ...
              <td><select name="parent_id" id="parent_id">
                  ...
                  <?php if ($news['news_id'] == $parent_id) { ?>
                  <option value="<?php echo $news['news_id']; ?>" class="<?php echo $news['top']; ?>" selected="selected"><?php echo $news['name']; ?></option>
                  <?php } else { ?>
                  <option value="<?php echo $news['news_id']; ?>" class="<?php echo $news['top']; ?>"><?php echo $news['name']; ?></option>
                  <?php } ?>
                  <?php } ?>
                </select></td>
            </tr>
...
<script type="text/javascript"><!--
			...
			if ($("#parent_id :selected").hasClass('1')) {
				 $('input[name="top"]').attr('checked', 'checked');
				}
			else { 
