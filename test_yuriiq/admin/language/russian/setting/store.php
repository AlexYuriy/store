...
$_['entry_customer_price']         = 'Требуется логин для просмотра цен:<br /><span class="help">Показывать цены только зарегистрированнным покупателям.</span>';
...
$_['entry_icon']                   = 'Иконка:';
$_['entry_image_menu_category']    = 'Размер изображений категорий в меню:';
...
$_['error_image_menu_category']    = 'Необходимо установить размер изображения категории в меню!';
