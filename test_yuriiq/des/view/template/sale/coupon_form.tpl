          ...
          <table class="form">
            ...
            <tr>
              ...
              <td><div id="coupon-product" class="scrollbox">
                  <?php $class = 'odd'; ?>
                  <?php foreach ($coupon_product as $coupon_products) { ?>
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div id="coupon-product<?php echo $coupon_products['product_id']; ?>" class="<?php echo $class; ?>">
                      <?php echo $coupon_products['name']; ?><img src="view/image/delete.png" alt="" />
                    <input type="hidden" name="coupon_product[]" value="<?php echo $coupon_products['product_id']; ?>" />
                  </div>
                  <?php } ?>
                </div></td>
            </tr>
            ...
            <tr>
              ...
              <td><div id="coupon-category" class="scrollbox">
                  <?php $class = 'odd'; ?>
                  <?php foreach ($coupon_category as $coupon_categoryes) { ?>
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div id="coupon-category<?php echo $coupon_categoryes['category_id']; ?>" class="<?php echo $class; ?>">
                      <?php echo $coupon_categoryes['name']; ?><img src="view/image/delete.png" alt="" />
                    <input type="hidden" name="coupon_category[]" value="<?php echo $coupon_categoryes['category_id']; ?>" />
                  </div>
                  <?php } ?>
                </div></td>
            </tr>           
