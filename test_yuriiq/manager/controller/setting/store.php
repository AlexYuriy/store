...
class ControllerSettingStore extends Controller {
	...
	public function update() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->redirect($this->url->link('setting/setting', 'token=' . $this->session->data['token'] . '&store_id=' . $this->request->get['store_id'], 'SSL'));
		}
	...
	protected function getList() {
		...
		$this->data['insert'] = $this->url->link('setting/setting/insert', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['delete'] = $this->url->link('setting/setting/delete', 'token=' . $this->session->data['token'], 'SSL');	
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				'text' => $this->language->get('text_edit'),
				'href' => $this->url->link('setting/setting/update', 'token=' . $this->session->data['token'] . '&store_id=' . $result['store_id'], 'SSL')
			);
		...
		$this->template = 'setting/setting_list.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function getForm() { 
		...
		if (!isset($this->request->get['store_id'])) {
			$this->data['action'] = $this->url->link('setting/setting/insert', 'token=' . $this->session->data['token'], 'SSL');
		} else {
			$this->data['action'] = $this->url->link('setting/setting/update', 'token=' . $this->session->data['token'] . '&store_id=' . $this->request->get['store_id'], 'SSL');
		}
		...
		$this->template = 'setting/setting_form.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
