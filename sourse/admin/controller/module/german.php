...
class ControllerModuleGerman extends Controller {
 		...
 		if (isset($this->error['warning'])) {
  		...
  		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('module/german', 'token=' . $this->session->data['token'], 'SSL'),
      		'separator' => ' :: '
   		);
		
		$this->data['action'] = $this->url->link('module/german', 'token=' . $this->session->data['token'], 'SSL');
	...
	public function uninstall() {
		...
		if (isset($config_values["config_admin_language"]) and $config_values["config_admin_language"]==='de') {
			$config_values["config_admin_language"] = 'en';
			$values_changed = true;
		}
		if (isset($config_values["config_language"]) and $config_values["config_language"]==='de') {
	...
	private function validate() {
		if (!$this->user->hasPermission('modify', 'module/german')) {
